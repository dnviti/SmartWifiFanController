...
namespace Config { // Start of namespace for global configuration
  ...
  // --- Fan Curve ---
  const int MAX_CURVE_POINTS = 8; // This constant is now part of the Config namespace
  ...
  // --- Task Handles (declared extern, defined in main.cpp) ---
